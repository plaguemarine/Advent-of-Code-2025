...
public class Main
{
    ...
    static List<Integer> rollsXIndex = new ArrayList<>();
    static List<Integer> rollsYIndex = new ArrayList<>();

    public static void main(String[] args)
    {
        try (BufferedReader br = new BufferedReader(new FileReader("/Users/calum/IdeaProjects/Advent-of-Code-Day-1/2025/Day4/Part2/input.txt")))
        {
            String line;
            ...
            for(int x = 0; x < map.get(y).length(); x++)
            {
                ...
                if(letter == '@')
                {
                    ...
                    if (surroundingRolls < 4)
                    {
                        ...
                        char[] currentString = map.get(y).toCharArray();
                        currentString[x] = ('X');

                        map.set(y, String.copyValueOf(currentString));
                    }
                    else
                    {
                        System.out.print("@");
